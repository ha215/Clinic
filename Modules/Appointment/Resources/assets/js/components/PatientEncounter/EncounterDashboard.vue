                          ...
                          <ul class="list-inline m-0 p-0">
                             <li class="item mb-1">
                                <div class="d-flex align-items-center flex-wrap gap-1">
                                   ...
                                   <span v-if="EncounterDetails.user && EncounterDetails.user.first_name ">
                                         {{ EncounterDetails.user.first_name }} 
                                   </span>
                                </div>
                             </li>
                             <li class="item mb-1">
...
<span v-else>-</span>
                                         ...
                                         <table class="table dataTable">
                                            ...
                                            <tbody>
                                               ...
                                               <tr  v-for="(medical, index) in MedicalReportList" :key="index">
                                                  <td>
                                                     {{ medical.name ? medical.name : 'No Name Available' }}
                                                  </td>
                                                  <td>
  ...
  const addNotesValue=()=>{
       ...
       console.log("EncounterDetails:", EncounterDetails.value); // Log EncounterDetails

  if (!EncounterDetails.value) {
    console.error("EncounterDetails is not defined or is null.");
    return; 
  }
