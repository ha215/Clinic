...
<div class="table-content mb-5">
    <x-backend.section-header>
        ...
        <x-slot name="toolbar">
            ...
            <!-- <button class="btn btn-secondary d-flex align-items-center gap-1 btn-group" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" style="display: none;"><i class="ph ph-funnel"></i>{{__('messages.advance_filter')}}</button> -->
