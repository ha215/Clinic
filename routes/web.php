...
Route::group(['prefix' => 'app', 'middleware' => 'auth'], function () {
    ...
    Route::get('user-list', [PatientUserController::class, 'index'])->name('user_list');
    Route::get('patients-create', [PatientUserController::class, 'create'])->name('patients-create');
    Route::get('patients-edit/{id}', [PatientUserController::class, 'edit'])->name('patients-edit');
    Route::post('patients-store', [PatientUserController::class, 'store'])->name('patients-store');
    Route::post('patients-update', [PatientUserController::class, 'update'])->name('patients-update');

    Route::get('patients-view/{id}', [PatientUserController::class, 'view'])->name('patients-view');
    
    //appoinment
    Route::get('appoinment-list', [AppointmentsController::class, 'index'])->name('appoinment-list');
    Route::get('appoinment-create', [AppointmentsController::class, 'create'])->name('appoinment-create');
    Route::get('backend.patients.get_by_civil_id', [AppointmentsController::class, 'getCivil'])->name('backend.patients.get_by_civil_id');
     Route::get('backend.doctors.get_by_department', [AppointmentsController::class, 'getDepartment'])->name('backend.doctors.get_by_department');
     Route::post('appoinment-store', [AppointmentsController::class, 'store'])->name('appoinment-store');
     Route::get('backend_patients_list', [AppointmentsController::class, 'Patientindex'])->name('backend_patients_list');
     Route::get('doctor/appointment/encounter/{id}', [AppointmentsController::class, 'encounterDetails'])->name('doctor.appointment.encounter');
      Route::post('backend_patients_saveMedicine', [AppointmentsController::class, 'saveMedicine'])->name('backend_patients_saveMedicine');
    Route::post('backend_patients_saveTest', [AppointmentsController::class, 'saveTest'])->name('backend_patients_saveTest');
     Route::post('backend_update_status', [AppointmentsController::class, 'UpdateStatus'])->name('backend_update_status');
      Route::post('backend_PMB_status', [AppointmentsController::class, 'PMBStatus'])->name('backend_PMB_status');

    Route::post('backend_patients_saveDisease', [AppointmentsController::class, 'saveDisease'])->name('backend_patients_saveDisease');

    Route::post('backend_search-problem', [AppointmentsController::class, 'searchProblem'])->name('backend_patients_searchProblem');


     Route::get('backend_appointments_get_available_times', [AppointmentsController::class, 'getAvailableTimes'])->name('backend.appointments.get_available_times');

     Route::get('backend_print_Prescription/{id}', [AppointmentsController::class, 'PrescriptionDetails'])->name('backend.print.Prescription');

     Route::get('backend_tests_print/{id}', [AppointmentsController::class, 'Testprint'])->name('backend.tests.print');
    ...
    Route::post('doctor-store-service', [DoctorController::class, 'index'])->name('doctor-store-service');
    Route::post('doctor-store-shift', [DoctorController::class, 'index'])->name('doctor-store-shift');
    Route::post('doctor-store-leave', [DoctorController::class, 'index'])->name('doctor-store-leave');


     Route::get('PMS_patients_list', [PMSController::class, 'index'])->name('PMS_patients_list');
     Route::get('PMS_patients_view/{id}', [PMSController::class, 'show'])->name('PMS_patients_view');
     Route::post('PMS_patients_upload', [PMSController::class, 'upload'])->name('PMS_patients_upload');
    
     Route::get('encounter-medical-report/missing', [PMSController::class, 'missingFiles'])->name('encounter-medical-report.missing');
     Route::post('encounter-medical-report.uploadFile', [PMSController::class, 'uploadPending'])->name('encounter-medical-report.uploadFile');


     Route::get('patients/template', [PatientController::class, 'downloadTemplate'])->name('patients.template');

     Route::post('patients/import', [PatientUserController::class, 'import'])->name('patients.import');

     Route::get('settings-index', [SettingsController::class, 'index'])->name('settings-index');

     Route::post('settings/storeNationality', [SettingsController::class, 'storeNationality'])->name('settings.storeNationality');

      Route::post('settings/storeProblem', [SettingsController::class, 'storeProblem'])->name('settings.storeProblem');

       Route::post('settings/storeService', [SettingsController::class, 'storeService'])->name('settings.storeService');

    // Language Switch
    Route::get('language/{language}', [LanguageController::class, 'switch'])->name('language.switch');
    Route::get('backend_language/{language}', [LanguageController::class, 'switch'])->name('backend.language.switch');
    Route::post('set-user-setting', [BackendController::class, 'setUserSetting'])->name('backend.setUserSetting');
    Route::get('patient/list', [LanguageController::class, 'switch'])->name('language.switch');
